...
class IDXChannelLoadMoreScraper:
    ...
    def scrape_single_day_with_loadmore(self, date_obj):
        ...
        # URL halaman utama untuk hari ini dengan idkanal=9772 (ekonomi)
        main_url = f"{self.base_url}/indeks?date={date_ymd}&idkanal=9772"
        ...
        while batch_count < max_batches:
            if batch_count == 0:
                ...
                # Format: https://www.idxchannel.com/indeks/more/{offset}?idkanal=9772&date=15-12-2025
                url = f"{self.base_url}/indeks/more/{current_offset}?idkanal=9772&date={date_dmy}"
                ...
                if load_more_button:
                    ...
                    if onclick_text:
                        ...
                        if js_url:
                            ...
                            # Contoh: https://www.idxchannel.com/indeks/more/9?idkanal=9772&date=15-12-2025
    ...
    def extract_articles_from_batch(self, soup, date_str, batch_num):
        ...
        for selector in selectors:
            ...
            if news_elements:
                # Filter hanya yang mengandung link market-news ATAU economics
                filtered_elements = []
                for elem in news_elements:
                    if elem.find('a', href=lambda x: x and ('/market-news/' in x or '/economics/' in x)):
    ...
    def extract_article_data(self, element, date_str, batch_num):
        ...
        try:
            # 1. Judul - perbaikan selector untuk menangani perbedaan struktur dan path economics
            title = "N/A"
            ...
            title_selectors = [
                ...
                'a[href*="/economics/"]'      # Link economics langsung
            ]
            ...
            if title == "N/A":
                all_links = element.find_all('a', href=lambda x: x and ('/market-news/' in x or '/economics/' in x))
            ...
            # 2. URL
            url = "N/A"
            link_elem = element.find('a', href=lambda x: x and ('/market-news/' in x or '/economics/' in x))
            if link_elem:
            ...
            # 6. Kategori
            category = "Economics"  # default untuk macro
    ...
    def save_results(self, articles, start_date, end_date):
        ...
        folder_path = "/Users/albert/Documents/Finances/data/raw/alternative_data/news/macro"
        ...
        filename = f"{folder_path}/idxchannel_macro_news_summary{start_str}_{end_str}_{timestamp}.json"
...
def main():
    """Program utama"""
    print("="*70)
    print("IDX CHANNEL MACRO SCRAPER (Economics)")
    print("="*70)
    ...
    print(f"🔗 Kanal: Economics (idkanal=9772)")
    print(f"🔗 Pattern URL: /indeks/more/[offset]?idkanal=9772&date=DD-MM-YYYY")
    ...
    try:
        ...
        if 'scraper' in locals() and 'articles' in locals() and articles:
            folder_path = "/Users/albert/Documents/Finances/data/raw/alternative_data/news/macro"
            timestamp = datetime.now().strftime("%H%M%S")
            temp_file = f"{folder_path}/idxchannel_partial_{timestamp}.json"
...
def test_single_day():
    ...
    if articles:
        ...
        filename = f"{folder_path}/test_loadmore_{timestamp}.json"
