...
async def main():
    channel_link = "https://t.me/akademicuanbersama_free"
    channel_name = channel_link.split("/")[-1]
    filename = f"/Users/albert/Documents/Finances/data/raw/alternative_data/telegram/data/ACB/{channel_name}_messages_20260129_20260131_days.csv" ## replace x_days
