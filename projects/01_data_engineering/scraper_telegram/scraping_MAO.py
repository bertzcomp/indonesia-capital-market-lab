...
async def main():
    channel_link = "https://t.me/manuverasetofficial"
    channel_name = channel_link.split("/")[-1]
    filename = f"/Users/albert/Documents/Finances/data/raw/alternative_data/telegram/data/MAO/{channel_name}_messages_20260128_20260131.csv" ## replace x_days
